...
menu.show('home');assert(menu.opened);key('ArrowDown');key('Enter');assert.equal(selected,'soccer');assert(!menu.opened);
menu.show('soccer');key('ArrowUp');key('ArrowLeft');key('Enter');assert.equal(selected,'toys','arrow navigation wraps');
