...
import { Trampoline } from './graphics.ts';
import { TRAMPOLINE, TrampolinePhysics } from './physics.ts';
import type { Facility } from '../../../../facilities/manager.ts';
import { FacilityMotionSound, type FacilitySoundSink } from '../../../../facilities/sound.ts';
