...
import { FacilityCollision, type CollisionBox } from '../../../../facilities/collision.ts';
import type { FacilityShadows } from '../../../../facilities/shadows.ts';
import { Tricycle } from './graphics.ts';
import { ToyTrack } from '../../graphics/track.ts';
import { TricyclePhysics } from './physics.ts';
import type { Facility } from '../../../../facilities/manager.ts';
import { box, TRACK_SHADOW_ENVELOPE } from '../../layout.ts';
import { fitGrips } from './fit.ts';
