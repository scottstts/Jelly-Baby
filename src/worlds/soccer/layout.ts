...
export const FIELD_RAMP={x:ENTRANCE.x,width:.30,start:FIELD.length/2,end:FIELD.length/2+.16,toeY:.0015,baseY:.00015} as const;
export const PITCH_CONTACT_MARGIN=.00035;
